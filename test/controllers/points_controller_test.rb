...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { effort_id: @point.effort_id, event_id: @point.event_id, feature_id: @point.feature_id, user_id: @point.user_id }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { effort_id: @point.effort_id, event_id: @point.event_id, feature_id: @point.feature_id, user_id: @point.user_id }
    assert_redirected_to point_path(assigns(:point))
  end
