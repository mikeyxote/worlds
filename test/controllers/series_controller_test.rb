...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post :create, series: { description: @series.description, end_date: @series.end_date, name: @series.name, start_date: @series.start_date }
    end
  ...
  test "should update series" do
    patch :update, id: @series, series: { description: @series.description, end_date: @series.end_date, name: @series.name, start_date: @series.start_date }
    assert_redirected_to series_path(assigns(:series))
  end
